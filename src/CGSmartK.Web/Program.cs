...
var auth=builder.Environment.IsDevelopment()?DevelopmentAuthenticationHandler.Scheme:EasyAuthAuthenticationHandler.Scheme;
builder.Services.AddAuthentication(auth).AddScheme<AuthenticationSchemeOptions,DevelopmentAuthenticationHandler>(DevelopmentAuthenticationHandler.Scheme,_=>{}).AddScheme<AuthenticationSchemeOptions,EasyAuthAuthenticationHandler>(EasyAuthAuthenticationHandler.Scheme,_=>{});
